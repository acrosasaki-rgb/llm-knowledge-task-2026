...
model_key="${AKBC_MODEL_KEY:-qwen3.5-27b-bf16-area-grounding-temp02}"
config="${AKBC_CONFIG:-configs/experiment-qwen-3.5-27b-bf16-thinking-empty-aware-20-area-grounding-temp02.yaml}"
...
echo "area-grounding-temp02 wall time: ${elapsed} s"
echo "area-grounding-temp02 completed: outputs/${model_key}-candidates.jsonl"
