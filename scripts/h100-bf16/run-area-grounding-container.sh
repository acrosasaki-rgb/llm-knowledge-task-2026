...
model_key="${AKBC_MODEL_KEY:-qwen3.5-27b-bf16-area-grounding}"
...
echo "area-grounding wall time: ${elapsed} s"
echo "area-grounding completed: outputs/${model_key}-candidates.jsonl"
