...
model_key="${AKBC_MODEL_KEY:-qwen3.5-27b-bf16-area-grounding-tladder}"
config="${AKBC_CONFIG:-configs/experiment-qwen-3.5-27b-bf16-thinking-empty-aware-20-area-grounding-tladder.yaml}"
...
echo "area-grounding-tladder wall time: ${elapsed} s"
echo "area-grounding-tladder completed: outputs/${model_key}-candidates.jsonl"
