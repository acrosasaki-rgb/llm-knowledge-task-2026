...
model_key="${AKBC_MODEL_KEY:-qwen3.5-27b-bf16-area-grounding-step}"
config="${AKBC_CONFIG:-configs/experiment-qwen-3.5-27b-bf16-thinking-empty-aware-20-area-grounding-step.yaml}"
...
echo "area-grounding-step wall time: ${elapsed} s"
echo "area-grounding-step completed: outputs/${model_key}-candidates.jsonl"
