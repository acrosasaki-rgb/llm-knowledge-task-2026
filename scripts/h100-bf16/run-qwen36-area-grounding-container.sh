...
model_key="${AKBC_MODEL_KEY:-qwen3.6-27b-bf16-area-grounding}"
config="${AKBC_CONFIG:-configs/experiment-qwen-3.6-27b-bf16-area-grounding.yaml}"
...
gguf_part1="BF16/Qwen3.6-27B-BF16-00001-of-00002.gguf"
gguf_part2="BF16/Qwen3.6-27B-BF16-00002-of-00002.gguf"
...
echo "qwen36-area-grounding wall time: ${elapsed} s"
echo "qwen36-area-grounding completed: outputs/${model_key}-candidates.jsonl"
