...
model_key="${AKBC_MODEL_KEY:-qwen3.5-27b-bf16-area-grounding-ppen}"
config="${AKBC_CONFIG:-configs/experiment-qwen-3.5-27b-bf16-thinking-empty-aware-20-area-grounding-ppen.yaml}"
...
echo "area-grounding-ppen wall time: ${elapsed} s"
echo "area-grounding-ppen completed: outputs/${model_key}-candidates.jsonl"
