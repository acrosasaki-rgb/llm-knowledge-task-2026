...
for variable_name in \
  AKBC_MODEL_KEY AKBC_CONFIG AKBC_PARALLEL AKBC_CLIENTS_PER_GPU AKBC_CTX_PER_SLOT AKBC_GGUF_REPO AKBC_GGUF_REV AKBC_GGUF_PART1 AKBC_GGUF_PART2 AKBC_GGUF_MIN_GIB AKBC_SUBJECTS AKBC_INPUT_FILE AKBC_DATA_FILE AKBC_SPLIT AKBC_REASONING_FLAGS HF_TOKEN \
